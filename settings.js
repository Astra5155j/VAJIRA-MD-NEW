...
const BOTNAME = 'recursive';
const FOOTERNAME = '> recursive';
global.owner = process.env.OWNER_NUMBER  || '9199xxxxxxx' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=6V90gDYY#Az7V0FcTklR9J7ONu6WbfcVStSgxRigl505PNKBqeQw' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'recursive' ,
